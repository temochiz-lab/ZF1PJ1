...
- [tickets](../../../../08_データベース.md#tickets): 現在の主テーブルだが、住所系カラムは存在しない。

## 詳細

住所情報を表示用文字列に整形するView Helper。

複数の住所系フィールドを見て、値があるものを組み合わせる想定の処理になっている。しかし現在の [tickets](../../../../08_データベース.md#tickets) テーブルには住所項目がなく、チケットCRUD画面からも呼ばれていない。
